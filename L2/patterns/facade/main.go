...
// В данной реализации фасадом у меня является функция Sell, которая имеет под собой работу со сложной бизнес логикой,
// где происходит взаимодействие с пользователем, банком и тд
